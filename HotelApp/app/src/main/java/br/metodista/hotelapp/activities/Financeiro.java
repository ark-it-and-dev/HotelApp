...
//        }
        ...
        protected void onPostExecute(List<Usuario> usuarios) {
            ...
            if (usuarios == null) {
                Toast.makeText(Financeiro.this, "Toast", Toast.LENGTH_SHORT).show();
            } else {
                ...
                if (listaConsumo != null) {
                    for (Produto produto : listaConsumo) {
                        ...
                        preco.setText("R$" + String.format("%.2f", produto.getPreco()));
